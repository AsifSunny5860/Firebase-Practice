...
public class ComfortListAdapter extends RecyclerView.Adapter<ComfortListAdapter.ViewHolder> {

    private List<House> houseList;
    private  ClickListener clicklistener = null;

    public ComfortListAdapter(List<House> houseList) {
        this.houseList = houseList;
    }
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.user_item_layout2,parent,false);
